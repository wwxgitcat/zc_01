...
if (method_exists($this, '_doRefund'))
{
	...
	$outputRefund .= zen_draw_form('lpapirefund', FILENAME_ORDERS, zen_get_all_get_params(array(
		'action' 
...
if (method_exists($this, '_doCapt'))
{
	...
	$outputCapt .= zen_draw_form('lpapicapture', FILENAME_ORDERS, zen_get_all_get_params(array(
		'action' 
...
if (method_exists($this, '_doVoid'))
{
	...
	$outputVoid .= zen_draw_form('lpapivoid', FILENAME_ORDERS, zen_get_all_get_params(array(
		'action' 
