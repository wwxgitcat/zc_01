...
class freecharger
{
	...
	{
		return array(
			'title' => MODULE_PAYMENT_FREECHARGER_TEXT_DESCRIPTION 
		);
	}
	...
	{
		return array(
			'MODULE_PAYMENT_FREECHARGER_STATUS',
			'MODULE_PAYMENT_FREECHARGER_ZONE',
			'MODULE_PAYMENT_FREECHARGER_ORDER_STATUS_ID',
