...
if (method_exists($this, '_doRefund'))
{
	...
	$outputRefund .= zen_draw_form('aimrefund', FILENAME_ORDERS, zen_get_all_get_params(array(
		'action' 
...
if (method_exists($this, '_doCapt'))
{
	...
	$outputCapt .= zen_draw_form('aimcapture', FILENAME_ORDERS, zen_get_all_get_params(array(
		'action' 
...
if (method_exists($this, '_doVoid'))
{
	...
	$outputVoid .= zen_draw_form('aimvoid', FILENAME_ORDERS, zen_get_all_get_params(array(
		'action' 
