...
if (isset($_POST['action']) && ($_POST['action'] == 'process'))
{
	...
	else
	{
		...
		// TODO: this is customer follow
		add_new_customer_follow($_SESSION['customer_id'], $cookie->last_customer_id, $cookie->send_email);
		
		
		$zco_notifier->notify('NOTIFY_MODULE_CREATE_ACCOUNT_ADDED_CUSTOMER_RECORD', array_merge(array(
		...
		$zco_notifier->notify('NOTIFY_MODULE_CREATE_ACCOUNT_ADDED_ADDRESS_BOOK_RECORD', array_merge(array(
		...
		if (sizeof($_SESSION['navigation']->snapshot) > 0)
		{
			...
			$origin_href = zen_href_link($_SESSION['navigation']->snapshot['page'], zen_array_to_string($_SESSION['navigation']->snapshot['get'], array(
				zen_session_name()
