...
for($i = 0, $n = sizeof($products); $i < $n; $i++)
{
	...
	$quantityField = zen_draw_input_field('cart_quantity[]', $products[$i]['quantity'], 'size="2" class="form-control"');
