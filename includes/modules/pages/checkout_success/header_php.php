...
//-->
	...
	echo "\n" . '<form action="' . zen_href_link(FILENAME_CHECKOUT_SUCCESS, zen_get_all_get_params(array(
		'action' 
	)), 'SSL', false) . '" method="post" name="formpost" />' . "\n";
	reset($_POST);
...
if (isset($_SESSION['is_create_user']) && $_SESSION['is_create_user']>0){
    ...
    $_SESSION['customer_guest_id'] = true;
}
