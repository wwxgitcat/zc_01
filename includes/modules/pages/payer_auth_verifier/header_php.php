 ...
 * will return the customer to.
 * The Card Issuer will POST the results
...
else
{
	...
	{
		$authenticate_data_array = array(
			'transaction_id' => $_SESSION['3Dsecure_transactionId'],
			'payload' => $_POST["PaRes"] 
		);
...
<body onLoad="onLoadHandler();">
	<center>
		<form name="frmResultPage" target="_top" method="post"
			action="<?php echo $redirectPage; ?>">
			<br />Processing. Please wait. <br />
			<br />
			<em>This may take a few moments...</em> <br />
			<br /><?php echo zen_image(DIR_WS_IMAGES.'3ds/pleasewait.gif');?>
