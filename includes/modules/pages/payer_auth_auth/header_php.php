 ...
 * Issuer's Access Control Server (ACS).
 * The ACS will in turn display
...
<body onLoad="onLoadHandler();">
	...
	<br>
	<center>
		<form name="frmLaunchACS" method="post"
			action="<?php echo $_SESSION['3Dsecure_acsURL']; ?>">
			<input type=hidden name="PaReq"
				value="<?php echo $_SESSION['3Dsecure_payload']; ?>"> <input
				type=hidden name="TermUrl"
				value="<?php echo $_SESSION['3Dsecure_term_url']; ?>"> <input
				type=hidden name="MD" value="<?php echo zen_session_id(); ?>">
			<noscript>
				<br>
				<br>
				<center>
