...
{
	zen_redirect(zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params(array(
		'action' 
	))));
}
...
if (isset($_GET['action']) && ($_GET['action'] == 'process'))
{
	...
	if ($error == false)
	{
		...
		else
		{
			...
			// end send email  $_GET['products_id'] zlink(FILENAME_PRODUCT_INFO,'products_id='.$id)
		}
		//zen_redirect(zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params(array('action' ))));
		zen_redirect(zen_href_link(FILENAME_PRODUCT_INFO,'products_id='.$_GET['products_id']));
	}
}
