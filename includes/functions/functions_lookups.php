 ...
 *
 * @param
 *        	int If set limits to a single country
 * @param
 *        	boolean If true adds the iso codes to the array
 *        	
 */
...
/*
 * Return the zone (State/Province) name TABLES: zones
 */
 ...
 *
 * @param
 *        	int The product id of the product who's name we want
 * @param
 *        	int The language id to use. If this is not set then the current language is used
 *        	
 */
 ...
 *
 * @param
 *        	int The product id of the product who's stock we want
 *        	
 */
 ...
 *
 * @param
 *        	int The product id of the product whos's stock is to be checked
 * @param
 *        	int Is this amount of stock available
 *        	
...
/*
 * Return a product's category TABLES: products_to_categories
 */
...
/*
 * Return category's image TABLES: categories
 */
...
/*
 * Return category's name from ID, assuming current language TABLES: categories_description
 */
...
/*
 * Return a product's manufacturer's name, from ID TABLES: products, manufacturers
 */
...
/*
 * Return a product's manufacturer's image, from Prod ID TABLES: products, manufacturers
 */
...
/*
 * Return a product's manufacturer's id, from Prod ID TABLES: products
 */
...
/*
 * Return attributes products_options_sort_order TABLE: PRODUCTS_ATTRIBUTES
 */
...
/*
 * return attributes products_options_sort_order TABLES: PRODUCTS_OPTIONS, PRODUCTS_ATTRIBUTES
 */
...
/*
 * configuration key value lookup TABLE: configuration
 */
function zen_get_configuration_key_value($lookup)
{
	global $db;
	$configuration_query = $db->Execute("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key='" . $lookup . "'", false, true, CACHE_TIMELIFT);
...
/*
 * Get accepted credit cards There needs to be a define on the accepted credit card in the language file credit_cards.php example: TEXT_CC_ENABLED_VISA
 */
...
/*
 * configuration key value lookup in TABLE_PRODUCT_TYPE_LAYOUT Used to determine keys/flags used on a per-product-type basis for template-use, etc
 */
...
/*
 * stop regular behavior based on customer/store settings Used to disable various activities if store is in an operating mode that should prevent those activities
 */
...
/*
 * Return any field from products or products_description table Example: zen_products_lookup('3', 'products_date_added');
 */
...
/*
 * Return any field from categories or categories_description table Example: zen_categories_lookup('10', 'parent_id');
 */
...
/*
 * Find index_filters directory suitable for including template-specific immediate /modules files, such as: new_products, products_new_listing, featured_products, featured_products_listing, product_listing, specials_index, upcoming, products_all_listing, products_discount_prices, also_purchased_products
 */
