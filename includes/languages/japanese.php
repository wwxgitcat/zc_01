...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="' . HTTP_SERVER . DIR_WS_CATALOG . '" target="_blank">' . $_SERVER["HTTP_HOST"] . '</a>');
...
define('BOX_HEADING_CATEGORIES', 'カテゴリ一覧');
...
define('TYPE_BELOW', '記入してください ...');

define('ENTRY_COMPANY', '会社名:');
define('ENTRY_COMPANY_ERROR', '会社名を入力してください。');
define('ENTRY_COMPANY_TEXT', '');
define('ENTRY_GENDER', '性別:');
define('ENTRY_GENDER_ERROR', '性別を選択してください');
define('ENTRY_GENDER_TEXT', '*');
define('ENTRY_FIRST_NAME', '姓:');
define('ENTRY_FIRST_NAME_ERROR', '姓は最低' . ENTRY_LAST_NAME_MIN_LENGTH . '文字以上入力してください');
define('ENTRY_FIRST_NAME_TEXT', '*');
define('ENTRY_LAST_NAME', '名:');
define('ENTRY_LAST_NAME_ERROR', '名は最低' . ENTRY_FIRST_NAME_MIN_LENGTH . '文字以上入力してください');
...
define('ENTRY_PASSWORD_TEXT', '* (半角英数字で' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上)');
...
define('WARNING_INSTALL_DIRECTORY_EXISTS', '警告: インストールディレクトリがそのまま残っています : %s. セキュリティ上危険なのでこのディレクトリを削除してください。');
define('WARNING_CONFIG_FILE_WRITEABLE', '警告: 設定ファイルが書き込み可能になっています : %s. セキュリティ上危険なので、このファイルに正しいユーザー権限を設定して下さい。 (read-only, CHMOD 644 or 444 are typical). You may need to use your webhost control panel/file-manager to change the permissions effectively. Contact your webhost for assistance. <a href="http://tutorials.zen-cart.com/index.php?article=90" target="_blank">この FAQ をご覧ください。</a>');
define('ERROR_FILE_NOT_REMOVEABLE', 'エラー: 指定されたファイルを削除できません。 サーバ権限設定の制限のために FTPを使ってファイル削除をする必要があるかもしれません。');
...
define('WARNING_COULD_NOT_LOCATE_LANG_FILE', '警告: language fileが見つかりません: ');
...
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD', 'カード番号の最初の４桁: %s が間違いでなければ、当ショップではこのカードのお取り扱いができません。番号が間違っているようでしたらもう一度入力してください。そうでなければ別のクレジットカードをお使いください');
...
define('GV_HAS_VOUCHERA', 'お客様の' . TEXT_GV_NAME . 'アカウントに残高があります。ご希望でしたらこの残高を <a class="pageResults" href="');

define('GV_HAS_VOUCHERB', '"><strong>Eメール</strong></a>で送ることができます。');
...
define('TEXT_INVALID_FINISHDATE_COUPON', 'このクーポンは有効期限が切れています');
...
define('TEXT_REMOVE_REDEEM_COUPON_ZONE', 'お客様が入力されたクーポンコードは選択された住所ではお使いいただくことができません。');
...
define('SUCCESS_ADDED_TO_CART_PRODUCT', '商品をカートに入れました...');
// only for where multiple add to cart is used:
define('SUCCESS_ADDED_TO_CART_PRODUCTS', '選択した商品をカートに入れました...');
...
define('TEXT_PRODUCTS_MIX_OFF_SHOPPING_CART', '<br />*単位内オプション複合不可*<br />');
define('TEXT_PRODUCTS_MIX_ON_SHOPPING_CART', '*単位内オプション複合可<br />');

define('ERROR_MAXIMUM_QTY', '数量を変更しました - 個数制限のために一度にお求めいただける最大数がカートに入っています。この商品をご覧ください: ');
define('ERROR_CORRECTIONS_HEADING', 'こちらを修正してください: <br />');
define('ERROR_QUANTITY_ADJUSTED', '買物かごに追加された数量は修正されました。ご希望の商品は分数の数量ではお買い求めできません。商品の数量: ');
...
define('ERROR_PRODUCT_QUANTITY_MIN_SHOPPING_CART', ', は最小個数制限があります。');
define('ERROR_PRODUCT_QUANTITY_UNITS_SHOPPING_CART', ' ... 購入単位エラー - ');
define('ERROR_PRODUCT_QUANTITY_MAX_SHOPPING_CART', ' ... 最大個数エラー - ');

define('WARNING_SHOPPING_CART_COMBINED', 'お知らせ: お客様の便宜のため、現在の買物かごは前回のご訪問時の買物かごと一緒にさせていただきました。チェックアウト前に買物かごをご確認ください。');

// error on checkout when $_SESSION['customers_id' does not exist in customers table
define('ERROR_CUSTOMERS_ID_INVALID', 'お客様情報が有効ではありません!<br />再度ログインするか、アカウントを作成してください。');

define('TABLE_HEADING_FEATURED_PRODUCTS', 'おすすめ商品');
define('TABLE_HEADING_FEATURED_POPULAR', '本日人気商品');
define('TABLE_HEADING_FEATURED_POPULAR_KETWORD', 'フリーワードで絞り込み');
...
define('TABLE_HEADING_SPECIALS_INDEX', '%sの特価品');

define('CAPTION_UPCOMING_PRODUCTS', 'これらの商品は近日入荷予定です。');
define('SUMMARY_TABLE_UPCOMING_PRODUCTS', '表には近く入荷するの商品と入荷予定日が掲載されています。');
...
define('ERROR_CART_UPDATE', '<strong>ご注文内容を更新してください。</strong>');
define('IMAGE_BUTTON_UPDATE_CART', 'カートの内容を更新');
define('EMPTY_CART_TEXT_NO_QUOTE', 'すみません! 時間切れです... カートを更新して送料を確認してください...');
define('CART_SHIPPING_QUOTE_CRITERIA', '送料はお客様が選択された住所に基いて算出しています:');
...
define('TEXT_PRODUCTS_LISTING_ALPHA_SORTER_NAMES', '...から始まる商品');
define('TEXT_PRODUCTS_LISTING_ALPHA_SORTER_NAMES_RESET', '-- リセット--');


// home footer
define('TEXT_HOME_FOOTER_ABOUT_US', '会社概要');
define('TEXT_HOME_FOOTER_CONTACT_US', 'お問い合わせ');
define('TEXT_HOME_FOOTER_PAYMENT_METHOD', 'お支払い方法．送料');
define('TEXT_HOME_FOOTER_RETURN', '返品・交換について');

define('TEXT_HOME', 'ホーム');
define('TEXT_HOME_FOOTER_ABOUT_US', '会社概要');
define('TEXT_HOME_FOOTER_CONTACT_US', 'お問い合わせ');
define('TEXT_HOME_FOOTER_PAYMENT_METHOD', 'お支払い方法．送料');
define('TEXT_HOME_FOOTER_RETURN', '返品・交換について');
...
define('TEXT_CATEGORIES_NO_PRODUCTS', 'このカデコリーに属する商品がありません。');

define('TEXT_PRODUCT_DETAIL', '商品詳細');
define('TEXT_PRODUCT_RELATED', '関連商品');
