...
define('HTML_PARAMS', 'dir="ltr" lang="us"');
...
define('TEXT_HOME_FOOTER_ABOUT_US', 'About US');
define('TEXT_HOME_FOOTER_CONTACT_US', 'Contact US');
define('TEXT_HOME_FOOTER_PAYMENT_METHOD', 'Payment Method');
define('TEXT_HOME_FOOTER_RETURN', 'Returned');


define('TEXT_CATEGORIES_NO_PRODUCTS', 'The categories no products');

define('TEXT_PRODUCT_DETAIL', 'Product Details');
define('TEXT_PRODUCT_RELATED', 'Product related');
