...
define('TEXT_CVV_HELP1', 'Visa, Mastercard, Discover 3 Digit Card Verification Number<br /><br />
                    ...
                    It appears after and to the right of your card number.<br />' . zen_image(DIR_WS_TEMPLATE_ICONS . 'cvv2visa.gif'));
...
define('TEXT_CVV_HELP2', 'American Express 4 Digit Card Verification Number<br /><br />
                    ...
                    It appears after and to the right of your card number.<br />' . zen_image(DIR_WS_TEMPLATE_ICONS . 'cvv2amex.gif'));
