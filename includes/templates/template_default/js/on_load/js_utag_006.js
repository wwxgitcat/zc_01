//tealium universal tag - utag.7 ut4.0.201410180127, Copyright 2014 Tealium.com Inc. All Rights Reserved.
var s_account="dcdcuggaustraliadev";var s=s_gi(s_account);s.dynamicAccountSelection=true;s.dynamicAccountList="dcdcuggaustraliaukprod=uggaustralia.co.uk";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters="web.deckers.demandware.net,uggaustralia.co.uk";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="GBP";s.visitorNamespace="deckers";s.trackingServer="sec.uggaustralia.com";s.trackingServerSecure="ssec.uggaustralia.com";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.25.4';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(s.rep(m,\"\\\\\",\"\\\\"
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s;u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={"page_name":"pageName","page_section_name":"channel,prop5,eVar4","page_category_name":"prop6,eVar7","ab_test1":"eVar35","ab_test2":"eVar36","ab_test3":"eVar37","akamai":"eVar33","backorder":"prop3,eVar13","billing_state":"eVar43,state","billing_zip":"eVar44,zip","campaign_internal":"eVar2","child_sku_color":"eVar25","child_sku_size":"eVar26","content_type":"eVar48","counterfeit_sites":"eVar32","country":"prop12","coupon_codes":"eVar34","customer_service":"prop10","error_page":"pageType","order_payment_type":"eVar9","page_subcategory_name":"prop7,eVar8","page_type":"prop8","page_type:product":"prodView,event2","page_type:search":"event1","product_detail_info":"prop11,eVar11","product_finding_methods":"eVar3","sales_agent":"eVar51","shipping_method":"eVar10","social_media_share":"eVar40","store_locator":"prop9,eVar15","sub_category_merchandising":"eVar8","tool_usage":"eVar14","user_rating":"eVar42","user_rating_number":"eVar45","vendor":"prop13,eVar29","video_name":"eVar46","_cbrand":"eVar47","search_term":"prop1,eVar1","search_results":"prop2","events:cartOpen":"scOpen,scAdd","events:cartRemove":"scRemove","events:scView":"scView","events:360 view":"event3","events:zoom view":"event4","events:emailFriend":"event13","events:emailRegister":"event21","events:chatInitiate":"event24","events:chatClicks":"event27","events:null search":"event28","events:fake":"event29","events:legit":"event30","events:undetermined":"event31","events:emailRegister2":"event32","events:socialMedia":"event33","events:shoeViewModify":"event35","events:shoeColorModify":"event36","events:facebookLikes":"event38","events:videoPlays":"event21,event39","events:videoViews":"event40","events:videoSegmentViews":"event41","events:videoComplete":"event42","events:coupon":"event22","events:sipe_score":"event87","events:impressions":"event15","events:clicks":"event16","events:cartAdd":"scOpen,scAdd","pipeline_name:FindStores-Find":"event23","pipeline_name:CustomerService-Show":"event25","pipeline_name:Cart-Show":"scView","pipeline_name:COCustomer-Start":"scCheckout,event37","order_id":"purchaseID,eVar24","page_error_type":"prop18","retail_inventory_zipcode_geolocated":"prop28","retail_inventory_searchterm":"prop29","retail_inventory_numresults":"prop30","retail_inventory_seemore":"prop31","retail_inventory_phone":"prop32"};u.extend=[function(a,b){b.sc_price_array=[];var vat_pcnt=.2;for(i=0;i<b.product_id.length;i++){if(!b.product_category[i].match(/kid|baby|infant|girl|boy|child|toddler/)){new_amt=(parseFloat(b.product_unit_price[i])/(1+vat_pcnt)).toFixed(2);b.sc_price_array.push(new_amt);}else{b.sc_price_array.push(parseFloat(b.product_unit_price[i]).toFixed(2));}}},function(a,b){s.loadModule("Media")
s.Media.autoTrack=false
s.Media.trackWhilePlaying=true
s.Media.trackVars="events,evar46,evar47,evar48"
s.Media.trackEvents="event39,event40,event41"
...
+" v==k?'':v");s.apl=new Function("l","v","d","u",""
...
+"substring(i+o.length);i=x.indexOf(o,i+l)}return x");s.crossVisitParticipation=new Function("v","cn","ex","ct","dl","ev","dv",""
...
+"(h,{delim:dl});if(ce)s.c_w(cn,'');return r;");s.getNewRepeat=new Function("d","cn",""
+"var s=this,e=new Date(),cval,sval,ct=e.getTime();d=d?d:30;cn=cn?cn:"
+"'s_nr';e.setTime(ct+d*24*60*60*1000);cval=s.c_r(cn);if(cval.length="
+"=0){s.c_w(cn,ct+'-New',e);return'New';}sval=s.split(cval,'-');if(ct"
+"-sval[0]<30*60*1000&&sval[1]=='New'){s.c_w(cn,ct+'-New',e);return'N"
+"ew';}else{s.c_w(cn,ct+'-Repeat',e);return'Repeat';}");s.clickThruQuality=new Function("scp","tcth_ev","cp_ev","cff_ev","cf_th",""
...
+"+cp_ev;}}}");s.manageQueryParam=new Function("p","w","e","u",""
...
+"qs='?'+qp;return u+qs");s.p_fo=new Function("n",""
+"var s=this;if(!s.__fo){s.__fo=new Object;}if(!s.__fo[n]){s.__fo[n]="
+"new Object;return 1;}else {return 0;}");s.getPreviousValue=new Function("v","c","el",""
+"var s=this,t=new Date,i,j,r='';t.setTime(t.getTime()+1800000);if(el"
+"){if(s.events){i=s.split(el,',');j=s.split(s.events,',');for(x in i"
+"){for(y in j){if(i[x]==j[y]){if(s.c_r(c)) r=s.c_r(c);v?s.c_w(c,v,t)"
+":s.c_w(c,'no value',t);return r}}}}}else{if(s.c_r(c)) r=s.c_r(c);v?"
+"s.c_w(c,v,t):s.c_w(c,'no value',t);return r}");s.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!s.wd[o])s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._d=0;p.disable=0;p.get"
...
+"m=s.wd[imn]=new Image;im.src=m._fu(p,u)}};m.script=function(u){var p=this,m=p._m;if(!p.disable)m.s.loadModule(0,m._fu(p,u),0,1)};m.l=new Array;if(m.onLoad)m.onLoad(s,m)";s.m_i("Integrate");s.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!m.s.wd[o])m.s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._d=0;p.disable="
+"0;p.get=m.get;p.delay=m.delay;p.ready=m.ready;p.beacon=m.beacon;p.script=m.script;m.l[m.l.length]=n};m._g=function(t){var m=this,s=m.s,i,p,f=(t?'use':'set')+'Vars',tcf;for(i=0;i<m.l.length;i++){p=m"
+"[m.l[i]];if(p&&!p.disable&&p[f]){if(s.apv>=5&&(!s.isopera||s.apv>=7)){tcf=new Function('s','p','f','var e;try{p[f](s,p)}catch(e){}');tcf(s,p,f)}else p[f](s,p)}}};m._t=function(){this._g(1)};m._fu=f"
+"unction(p,u){var m=this,s=m.s,v,x,y,z,tm=new Date;if(u.toLowerCase().substring(0,4) != 'http')u='http://'+u;if(s.ssl)u=s.rep(u,'http:','https:');p.RAND=Math&&Math.random?Math.floor(Math.random()*10"
+"000000000000):tm.getTime();p.RAND+=Math.floor(tm.getTime()/10800000)%10;x=0;while(x>=0){x=u.indexOf('[',x);if(x>=0){y=u.indexOf(']',x);if(y>x){z=u.substring(x+1,y);if(z.length>2&&z.substring(0,2)=="
+"'s.'){v=s[z.substring(2)];if(!v)v=''}else{v=''+p[z];if(!(v==p[z]||parseFloat(v)==p[z]))z=0}if(z) {u=u.substring(0,x)+s.rep(escape(v),'+','%2B')+u.substring(y+1);x=y-(z.length-v.length+1)} else {x=y"
+"}}}}return u};m.get=function(u,v){var p=this,m=p._m;if(!p.disable){if(!v)v='s_'+m._in+'_Integrate_'+p._n+'_get_'+p._c;p._c++;p.VAR=v;p._d++;m.s.loadModule('Integrate:'+v,m._fu(p,u),0,1,p._n)}};m.de"
+"lay=function(){var p=this;if(p._d<=0)p._d=1};m.ready=function(){var p=this,m=p._m;p._d=0;if(!p.disable)m.s.dlt()};m._d=function(){var m=this,i,p;for(i=0;i<m.l.length;i++){p=m[m.l[i]];if(p&&!p.disab"
+"le&&p._d>0)return 1}return 0};m._x=function(d,n){var p=this[n],x;if(!p.disable){for(x in d)if(x&&(!Object||!Object.prototype||!Object.prototype[x]))p[x]=d[x];p._d--}};m.beacon=function(u){var p=thi"
+"s,m=p._m,s=m.s,imn='s_i_'+m._in+'_Integrate_'+p._n+'_'+p._c,im;if(!p.disable&&s.d.images&&s.apv>=3&&(!s.isopera||s.apv>=7)&&(s.ns6<0||s.apv>=6.1)){p._c++;im=s.wd[imn]=new Image;im.src=m._fu(p,u)}};"
+"m.script=function(u){var p=this,m=p._m;if(!p.disable)m.s.loadModule(0,m._fu(p,u),0,1)};m.l=new Array;if(m.onLoad)m.onLoad(s,m)";s.m_i("Integrate");},function(a,b){s.usePlugins=true
function s_doPlugins(s){if(!s.campaign)
s.campaign=s.getQueryParam('source');if(!s.campaign)
s.campaign=s.getQueryParam('mSource');if(!s.campaign)
s.campaign=s.getQueryParam('sp_mid');if(!s.eVar2)
s.eVar2=s.getQueryParam('ICID');if(!s.eVar12)
s.eVar12=s.getQueryParam('SP_RID');var t_search=s.getValOnce(s[s.searchTermVariable],'ev1',0)
if(t_search=='')
...
{if(!s.products)
s.products=';';}
s.eVar22=s.crossVisitParticipation(s.campaign,'s_cpm','30','5','>','purchase');s.eVar21=s.getNewRepeat();s.prop22=s.getPreviousValue(s.pageName,'gpv','');if(/event21/i.test(s.events))s.eVar46=s.prop22;if(/event32/i.test(s.events))s.eVar46=s.prop22;}
s.doPlugins=s_doPlugins},function(a,b){if((typeof b['coupon_discount_amount']!='undefined'&&typeof b['coupon_discount_amount']!='undefined'&&b['coupon_discount_amount']!='')){b['events']='coupon'}}];u.send=function(a,b,c,d,e,f,g,h,ev,evt){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:7");b.sc_events=b.sc_events||{};u.addEvent=function(v){var t=[];if(v instanceof Array){t=v.slice(0);}else{t.push(v);}
...
var price=b.sc_price_array?b.sc_price_array:b._cprice;c.push((b._ccat[d]?b._ccat[d]:"")+";"+b._cprod[d]+";"+(b._cquan[d]?b._cquan[d]:"")+";"+(price[d]?((b._cquan[d]?parseInt(b._cquan[d]):1)*parseFloat(price[d])).toFixed(2):"")+";"+h2+";"+e);}
u.o.products=c.join(",");}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('7','deckers.ugg-uk');}catch(e){};