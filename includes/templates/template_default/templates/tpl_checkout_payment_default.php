    ...
    <div id="order_steps">
		...
		<div class="order_steps_line_2">
			<span class="progressbar_active_COWOA">&nbsp;</span><span
				...
				class="progressbar_active_COWOA">&nbsp;</span><span
				class="progressbar_inactive_COWOA">&nbsp;</span><span
    ...
    <div id="order_steps">
		...
		<div class="order_steps_line_2">
			<span class="progressbar_active">&nbsp;</span><span
				...
				class="progressbar_inactive">&nbsp;</span><span
...
<address><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['billto'], true, ' ', '<br />'); ?></address>
	...
	<div class="floatingBox important forward btn_changges"><?php echo TEXT_SELECTED_BILLING_DESTINATION; ?></div>
	<br class="clearBoth" />
<?php 
// ** BEGIN PAYPAL EXPRESS CHECKOUT **
}
...
<?php
		...
		{
			?>
<?php if((!defined('J_COUPON_ENABLE') || J_COUPON_ENABLE == false) && !($COWOA && $selection[$i]['module']==MODULE_ORDER_TOTAL_GV_TITLE)) {?>
  <fieldset>
