...
<p><?php echo TEXT_SEND_ANOTHER; ?></p>
		<div class="buttonRow forward">
			<a
				href="<?php echo zen_href_link(FILENAME_GV_SEND, '', 'SSL', false); ?>"><?php echo zen_image_button(BUTTON_IMAGE_SEND_ANOTHER, BUTTON_SEND_ANOTHER_ALT); ?></a>
		</div>
<?php
}
?>
...
<!--BOF GV sent success-->
	...
	<div class="buttonRow forward">
		<a
			href="<?php echo zen_href_link(FILENAME_DEFAULT, '', 'SSL', false); ?>"><?php echo zen_image_button(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT); ?></a>
	</div>
	<!--EOF GV sent success -->
<?php
}
...
<!--BOF GV send confirm -->
	...
	<form
		action="<?php echo zen_href_link(FILENAME_GV_SEND, 'action=process', 'SSL', false); ?>"
		method="post">
...
<form
		action="<?php echo zen_href_link(FILENAME_GV_SEND, 'action=send', 'SSL', false); ?>"
		method="post">
...
<br class="clearBoth" /> <label class="inputLabel" for="email-address"><?php echo ENTRY_EMAIL; ?></label>
...
<br class="clearBoth" /> <label class="inputLabel" for="amount"><?php echo ENTRY_AMOUNT; ?></label>
...
<br class="clearBoth" /> <label for="message-area"><?php echo ENTRY_MESSAGE; ?></label>
