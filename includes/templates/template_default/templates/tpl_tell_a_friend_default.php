...
<fieldset>
		...
		<br class="clearBoth" /> <label class="inputLabel" for="from-name"><?php echo FORM_FIELD_CUSTOMER_NAME; ?></label>
...
<br class="clearBoth" /> <label class="inputLabel"
			for="from-email-address"><?php echo FORM_FIELD_CUSTOMER_EMAIL; ?></label>
<?php echo zen_draw_input_field('from_email_address','','id="from-email-address"') . '&nbsp;<span class="alert">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>'; ?>
<br class="clearBoth" /> <label class="inputLabel" for="to-name"><?php echo FORM_FIELD_FRIEND_NAME; ?></label>
<?php echo zen_draw_input_field('to_name', '', 'id="to-name"') . '&nbsp;<span class="alert">' . ENTRY_FIRST_NAME_TEXT . '</span>'; ?>
<br class="clearBoth" /> <label class="inputLabel"
			for="to-email-address"><?php echo FORM_FIELD_FRIEND_EMAIL; ?></label>
...
<br class="clearBoth" /> <label for="email-message"><?php echo FORM_TITLE_FRIEND_MESSAGE; ?></label>
