...
echo $order->products[$i]['name'];
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0"
		id="myAccountOrdersStatus"
		summary="Table contains the date, order status and any comments regarding the order">
		<caption>
...
<?php echo TEXT_LOOKUP_INSTRUCTIONS; ?><br />
		<br /> <label class="inputLabel"><?php echo ENTRY_EMAIL; ?></label>
<?php echo zen_draw_input_field('query_email_address', '' , 'size="35" id="query_email_address"'); ?> 
<br class="clearBoth" /> <label class="inputLabel"><?php echo ENTRY_ORDER_NUMBER; ?></label>
