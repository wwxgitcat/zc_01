...
if (isset($_GET['music_genre_id']))
{
	if (isset($_GET['filter_id']) && zen_not_null($_GET['filter_id']))
	{
        ...
        from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCT_MUSIC_EXTRA . " pme left join " . TABLE_SPECIALS . " s on pme.products_id = s.products_id, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c, " . TABLE_MUSIC_GENRE . " m
	...
	else
	{
        ...
        from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCT_MUSIC_EXTRA . " pme left join " . TABLE_SPECIALS . " s on pme.products_id = s.products_id, " . TABLE_MUSIC_GENRE . " m
        where  m.music_genre_id = '" . (int)$_GET['music_genre_id'] . "'
          and p.products_id = pme.products_id
          and p.products_status = 1
          and pd.products_id = pme.products_id
          and pd.language_id = '" . (int)$_SESSION['languages_id'] . "'
          and pme.music_genre_id = m.music_genre_id" . $alpha_sort;
	}
}
else
{
	...
	if (isset($_GET['filter_id']) && zen_not_null($_GET['filter_id']))
	{
        ...
        from " . TABLE_PRODUCTS . " p left join " . TABLE_SPECIALS . " s on p.products_id = s.products_id, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_MUSIC_GENRE . " m, " . TABLE_PRODUCT_MUSIC_EXTRA . " pme, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c
