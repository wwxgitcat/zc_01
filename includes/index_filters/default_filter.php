...
if (isset($_GET['manufacturers_id']) && $_GET['manufacturers_id'] != '')
{
	if (isset($_GET['filter_id']) && zen_not_null($_GET['filter_id']))
	{
		...
		$listing_sql = "select distinct p.products_id," . $select_column_list . " pd.products_name, p.products_type, p.master_categories_id, p.manufacturers_id, p.products_price, p.products_tax_class_id, pd.products_description, if(s.status = 1, s.specials_new_products_price, NULL) AS specials_new_products_price, IF(s.status = 1, s.specials_new_products_price, p.products_price) as final_price, p.products_sort_order, p.product_is_call, p.product_is_always_free_shipping, p.products_qty_box_status
       ...
       where p.products_status = 1
         ...
         and p.shop_id = ".(int)$_SESSION['shop_id'] . $alpha_sort;
	}
	else
	{
		// We show them all
...
else
{
	...
	else
	{
       ...
       where p.products_status = 1
         ...
         and p2c.categories_id IN (" . implode(', ', $sub_categories) . ") " . $alpha_sort;
	}
}
...
if (PRODUCT_LIST_FILTER > 0)
{
	if (isset($_GET['manufacturers_id']) && $_GET['manufacturers_id'] != '')
	{
      ...
      where p.products_status = 1
        ...
        and p2c.categories_id = cd.categories_id and p.shop_id = ".(int)$_SESSION['shop_id']."
	...
	else
	{
      ...
      where p.products_status = 1
        and p.manufacturers_id = m.manufacturers_id
        and p.products_id = p2c.products_id and p.shop_id = ".(int)$_SESSION['shop_id']."
        and p2c.categories_id = '" . (int)$current_category_id . "'
