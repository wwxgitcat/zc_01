...
if (isset($_GET['record_company_id']))
{
	if (isset($_GET['filter_id']) && zen_not_null($_GET['filter_id']))
	{
        ...
        from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCT_MUSIC_EXTRA . " pme left join " . TABLE_SPECIALS . " s on pme.products_id = s.products_id, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c, " . TABLE_RECORD_COMPANY . " r
	...
	else
	{
        ...
        from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_PRODUCT_MUSIC_EXTRA . " pme left join " . TABLE_SPECIALS . " s on pme.products_id = s.products_id, " . TABLE_RECORD_COMPANY . " r
        where r.record_company_id = '" . (int)$_GET['record_company_id'] . "'
          and p.products_id = pme.products_id
          and p.products_status = 1
          and pd.products_id = pme.products_id
          and pd.language_id = '" . (int)$_SESSION['languages_id'] . "'
          and pme.record_company_id = r.record_company_id" . $alpha_sort;
	}
}
else
{
	...
	if (isset($_GET['filter_id']) && zen_not_null($_GET['filter_id']))
	{
        ...
        from " . TABLE_PRODUCTS . " p left join " . TABLE_SPECIALS . " s on p.products_id = s.products_id, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_RECORD_COMPANY . " r, " . TABLE_PRODUCT_MUSIC_EXTRA . " pme, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c
	...
	else
	{
        ...
        where r.record_company_id = pme.record_company_id
          ...
          and pd.products_id = pme.products_id
          and p2c.products_id = p.products_id
          and pd.language_id = '" . (int)$_SESSION['languages_id'] . "'" . $alpha_sort;
		}
	}
}
