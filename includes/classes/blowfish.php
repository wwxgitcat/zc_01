...
class Crypt_Blowfish
{
	...
	function __construct($key, $iv)
	{
		...
		if (PHP_VERSION_ID == '50201' or PHP_VERSION_ID == '50206') $this->_unpackMode = PS_UNPACK_MODIFIED;
	...
	{
		if (pack('L', 0x6162797A) == pack('V', 0x6162797A)) return ((ord($str) << 24) | (ord(substr($str, 1)) << 16) | (ord(substr($str, 2)) << 8) | ord(substr($str, 3)));
		else
