...
class base
{
	 ...
	 *
	 * @param
	 *        	object Reference to the observer class
	 * @param
	...
	function attach(&$observer, $eventIDArray)
	{
		foreach($eventIDArray as $eventID)
		{
			...
			base::setStaticObserver($nameHash, array(
				'obs' => &$observer,
				'eventID' => $eventID 
			));
		}
	 ...
	 *
	 * @param
	 *        	string The event ID to notify for
	 * @param
	 *        	array paramters to pass to the observer, useful for passing stuff which is outside of the 'scope' of the observed class.
	 */
