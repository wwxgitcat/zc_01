...
class messageStack extends base
{
	...
	function add($class, $message, $type = 'error')
	{
		...
		if (strlen($message) > 0)
		{
			...
			{
				$theAlert = array(
					'params' => 'class="bg-danger messageStackError larger"',
					'class' => $class,
			...
			{
				$theAlert = array(
					'params' => 'class="bg-warning messageStackWarning larger"',
					'class' => $class,
			...
			{
				$theAlert = array(
					'params' => 'class="bg-success messageStackSuccess larger"',
					'class' => $class,
			...
			{
				$theAlert = array(
					'params' => 'class="bg-active messageStackCaution larger"',
					'class' => $class,
					'text' => zen_image($template->get_template_dir(ICON_IMAGE_WARNING, DIR_WS_TEMPLATE, $current_page_base, 'images/icons') . '/' . ICON_IMAGE_WARNING, ICON_WARNING_ALT) . '  ' . $message 
				);
			}
			...
			{
				$theAlert = array(
					'params' => 'class="bg-active messageStackError larger"',
					'class' => $class,
					'text' => $message 
				);
			}
