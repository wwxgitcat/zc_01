<?php
/*
 * @package utilities @copyright Copyright 2003-2011 Zen Cart Development Team @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0 @version $Id: curltester.php 18695 2011-05-04 05:24:19Z drbyte $ This utility is simply intended to test whether the host server has the ability to use CURL to connect to external servers in order to send communications, such as for PayPal transactions
 */
