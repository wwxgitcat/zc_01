...
<link rel="stylesheet" type="text/css"
	href="../<?php echo $tempdir; ?>dlf/styles.css" />
<?php
if ($showthumbnails)
{
	?>
...
<div id="dlf_container">
  <?php
	...
	<form enctype="multipart/form-data" action="easypopulate.php"
		method="post" id="auto_form">
		<input type='hidden' name='localfile' value=''>
		<div id="listingcontainer">
			<div id="listingheader">
				<div id="headerfile">
					<a href="<?php echo $baseurl . $fileurl; ?>">File</a>
				</div>
				<div id="headersize">
					<a href="<?php echo $baseurl . $sizeurl; ?>">Size</a>
				</div>
				<div id="headermodified">
					<a href="<?php echo $baseurl . $dateurl; ?>">Last Modified</a>
				</div>
			</div>
			<div id="listing">
		<?php
		...
		for($i = 0; $i < $arsize; $i++)
		{
			...
			<div>
					<input type="submit"
						<?php if (stripos($files[$i], '.csv')>0){echo 'id="auto'.$i.'"';}?>
						value="Import"
						onClick="this.form.localfile.value='<?php echo $files[$i]; ?>';"
						style="float: left; width: 50px;"> <a
						href="<?php echo $fileurl; ?>" class="<?php echo $class; ?>"
						<?php echo $thumb2; ?>> <img
						src="../<?php echo $tempdir; ?>dlf/<?php echo $icon; ?>"
						alt="<?php echo $files[$i]; ?>" /> <strong><?php echo $filename; ?></strong>
						<em><?php echo round(filesize($leadon.$files[$i])/1024); ?>KB</em>
...
<!--
var form = document.getElementById('auto_form');
var input = document.getElementById('auto<?php echo ($auto-1);?>');
if (input){
	input.click();
	//form.submit();
}
