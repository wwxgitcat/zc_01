...
define('TEXT_SHIPPING_INFO', '<strong>虚拟商品</strong>不要运费也不要送货地址, 例如, ' . TEXT_GV_NAMES . ', 等.<br />' . '<strong>总是免费</strong>不要运费, 但需要送货地址<br />' . '<strong>下载</strong>设定为虚拟商品 - 两个选项都不需要标记<br />');
