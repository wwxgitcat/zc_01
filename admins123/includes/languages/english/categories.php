...
define('TEXT_SHIPPING_INFO', '<strong>Virtual Products</strong> do not have a shipping charge and do not require a shipping address such a Services, ' . TEXT_GV_NAMES . ', etc.<br />' . '<strong>Always Free Shipping</strong> does not have a shipping charge, but do require a shipping address<br />' . '<strong>Downloads</strong> are assumed to be Virtual Products - Neither option needs to be marked<br />');
