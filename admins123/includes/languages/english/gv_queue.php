...
define('TEXT_REDEEM_GV_MESSAGE_RELEASED', 'For security reasons this was not made immediately available to you. ' . 'However, this amount has now been released. You may now visit our store and send the value of the ' . TEXT_GV_NAME . ' via email to someone else, or use it yourself.' . "\n\n");
