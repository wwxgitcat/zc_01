...
define('TEXT_INFO_PRODUCTS_TO_CATEGORIES_LINKER_INTRO', 'The Products to Categories Linker is designed to quickly link the current Product to one or to many Categories.<br />You may also Link all of the Products in a Category to another Category or Remove Linked Products from a Category that are in another Category. (See below for additional instructions)');

define('TEXT_INFO_PRODUCTS_TO_CATEGORIES_LINKER', 'For pricing purposes, each Product requires a Master Category, regardless of how many Categories it may be linked. This can be set via the Master Category Dropdown.<br />
