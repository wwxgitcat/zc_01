...
//--></script>';
	...
	function send($newsletter_id)
	{
		...
		if (isset($_POST['global']) && ($_POST['global'] == 'true'))
		{
			...
			while(!$products->EOF)
			{
				$audience[$products->fields['customers_id']] = array(
					'firstname' => $products->fields['customers_firstname'],
			...
			while(!$customers->EOF)
			{
				$audience[$customers->fields['customers_id']] = array(
