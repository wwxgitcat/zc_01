...
if ($prev_next_list == '')
{
	...
	$sql = "select p.products_id, pd.products_name
            ...
            where  p.products_id = pd.products_id and pd.language_id= '" . (int)$_SESSION['languages_id'] . "' and p.products_id = ptc.products_id and ptc.categories_id = '" . (int)$current_category_id . "'" . $prev_next_order;
...
/*
 * if (strstr($PHP_SELF, FILENAME_PRODUCTS_PRICE_MANAGER)) { $curr_page = FILENAME_PRODUCTS_PRICE_MANAGER; } else { $curr_page = FILENAME_ATTRIBUTES_CONTROLLER; }
 */
