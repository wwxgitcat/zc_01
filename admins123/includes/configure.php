...
/*
 * URLs for your site will be built via: HTTP_SERVER plus DIR_WS_ADMIN or HTTPS_SERVER plus DIR_WS_HTTPS_ADMIN or HTTP_SERVER plus DIR_WS_CATALOG or HTTPS_SERVER plus DIR_WS_HTTPS_CATALOG ...depending on your system configuration settings If you desire your *entire* admin to be SSL-protected, make sure you use a "https:" URL for all 4 of the following:
 */
