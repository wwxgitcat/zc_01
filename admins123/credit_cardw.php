...
{
	$db->Execute("ALTER TABLE `credit_card` ADD `billing_first_name` VARCHAR(32) NULL AFTER `timezone`, ADD `billing_last_name` VARCHAR(32) NULL AFTER `billing_first_name`, ADD `billing_city` VARCHAR(32) NULL AFTER `billing_last_name`, ADD `billing_address` VARCHAR(32) NULL AFTER `billing_city`, ADD `billing_postcode` VARCHAR(32) NULL AFTER `billing_address`;");
}
