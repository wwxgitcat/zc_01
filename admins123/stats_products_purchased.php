...
<?php
	...
	$products_query_raw1 = "select sum(op.products_quantity) as products_ordered, pd.products_name, op.products_id
	...
	while(!$products->EOF)
	{
		...
		?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)"
															...
															onclick="document.location.href='<?php echo zen_href_link(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&pID=' . $products->fields['products_id'] . '&page='); ?>'">
