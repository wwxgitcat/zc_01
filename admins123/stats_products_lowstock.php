	...
	if ($zc_products->get_allow_add_to_cart($products->fields['products_id']) == 'Y')
	{
		...
		?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)"
												...
												onclick="document.location.href='<?php echo zen_href_link($type_handler, '&product_type=' . $products->fields['products_type'] . '&cPath=' . $cPath . '&pID=' . $products->fields['products_id'] . '&action=new_product'); ?>'">
