...
switch($action)
{
	...
	case 'clean_debug_files':
		foreach(array(
			DIR_FS_LOGS,
			DIR_FS_SQL_CACHE,
			DIR_FS_CATALOG . '/includes/modules/payment/paypal/logs' 
		) as $purgeFolder)
		{
...
if ($processing_message != '')
{
	?>
  <tr>
						<td><?php echo $processing_message; ?></td>
					</tr>
					<tr>
						<td align="center"><?php echo zen_image(DIR_WS_IMAGES . 'loadingsmall.gif'); ?></td>
					</tr>
<?php
}
else
...
<!-- bof: update all option values sort orders -->
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_attributes_sort_order', FILENAME_STORE_MANAGER, 'action=update_all_products_attributes_sort_order')?><input
										type="hidden" name="confirm" value="yes" /><?php echo zen_image_submit('button_update.gif', IMAGE_UPDATE); ?></form></td>
								</tr>
							</table></td>
					</tr>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_price_sorter', FILENAME_STORE_MANAGER, 'action=update_all_products_price_sorter')?><input
										type="hidden" name="confirm" value="yes" /><?php echo zen_image_submit('button_update.gif', IMAGE_UPDATE); ?></form></td>
								</tr>
							</table></td>
					</tr>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									<form name="update_counter"
										action="<?php echo zen_href_link(FILENAME_STORE_MANAGER, 'action=update_counter', 'NONSSL'); ?>"
										method="post">
          <?php echo zen_draw_hidden_field('securityToken', $_SESSION['securityToken']); ?>
            <td class="main" align="left" valign="top"><?php echo TEXT_INFO_COUNTER_UPDATE; ?></td>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_viewed', FILENAME_STORE_MANAGER, 'action=update_all_products_viewed')?><input
										type="hidden" name="confirm" value="yes" /><?php echo zen_image_submit('button_reset.gif', IMAGE_UPDATE); ?></form></td>
								</tr>
							</table></td>
					</tr>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_products_ordered', FILENAME_STORE_MANAGER, 'action=update_all_products_ordered')?><input
										type="hidden" name="confirm" value="yes" /><?php echo zen_image_submit('button_reset.gif', IMAGE_UPDATE); ?></form></td>
								</tr>
							</table></td>
					</tr>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td class="main" align="right" valign="middle"><?php echo zen_draw_form('update_all_master_categories_id', FILENAME_STORE_MANAGER, 'action=update_all_master_categories_id')?><input
										type="hidden" name="confirm" value="yes" /><?php echo zen_image_submit('button_reset.gif', IMAGE_UPDATE); ?></form></td>
								</tr>
							</table></td>
					</tr>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									<form name="update_orders"
										action="<?php echo zen_href_link(FILENAME_STORE_MANAGER, 'action=update_orders_id', 'NONSSL'); ?>"
										method="post">
          <?php echo zen_draw_hidden_field('securityToken', $_SESSION['securityToken']); ?>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="2">
								<tr>
									...
									<td class="main" align="right" valign="middle"><?php echo zen_draw_form('optimize_db_start', FILENAME_STORE_MANAGER, 'action=optimize_db_start')?><input
										type="hidden" name="confirm" value="yes" /><?php echo zen_image_submit('button_reset.gif', IMAGE_UPDATE); ?></form></td>
								</tr>
							</table></td>
					</tr>
