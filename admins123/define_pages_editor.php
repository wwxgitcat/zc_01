...
<?php
										...
										echo TEXT_EDITOR_INFO . zen_draw_form('set_editor_form', FILENAME_DEFINE_PAGES_EDITOR, '', 'get') . '&nbsp;&nbsp;' . zen_draw_pull_down_menu('reset_editor', $editors_pulldown, $current_editor_key, 'onChange="this.form.submit();"') . zen_draw_hidden_field('action', 'set_editor') . zen_hide_session_id() . '</form>';
										?>
        </td>
					</tr>
<?php
									...
									<td><table width="100%" border="0" cellspacing="0"
											...
											<tr>
												<td class="smallText"><a
													href="<?php echo zen_href_link($_GET['filename'], 'lngdir=' . $_SESSION['language'] . '&filename=' . $filename); ?>"><b><?php echo $filename; ?></b></a></td>
<?php
