 ...
 * @version $Id: popup_file_select.php v1.0.0 13.10.2006 2:30 Andrew Berezin $
 */
...
<meta http-equiv="Content-Type"
	...
	<title>Zen Cart!</title> <script type="text/javascript">
  <!--
...
?>
			...
			<td valign="top" width="40%">
				<div id="fileinfo" style="display: none; text-align: center">
					...
					<img src="" border="0" alt="" title="" id="fileimg" /> <br />
					<a href="" id="imageSelectHref"> Select <br /> <span id="imageName"></span>
					</a>
				</div>
			</td>
		</tr>
